    ...
    public class Trade
    {
        ...
        public void SetTradeFromString(string In)
        {
            ...
            if (sIn.Length >= 6 && (sIn[5] == "C" || sIn[5] == "S"))
            {
                ...
                Price = Convert.ToDecimal(sIn[1]);
                Volume = Convert.ToDecimal(sIn[2]);
                Bid = Convert.ToDecimal(sIn[3]);
                Ask = Convert.ToDecimal(sIn[4]);
                Side = GetSideIqFeed();
            ...
            if (sIn.Length > 7)
            {
                Bid = Convert.ToDecimal(sIn[7]);
                Ask = Convert.ToDecimal(sIn[8]);
